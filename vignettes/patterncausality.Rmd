...
The `pcLightweight` function performs a lightweight pattern causality analysis.
  - `X`: The first time series (Apple stock prices).
  - `Y`: The second time series (Microsoft stock prices).
  - `E`: The embedding dimension.
  - `tau`: The time delay.
  - `metric`: The distance metric to use.
  - `h`: The prediction horizon.
  - `weighted`: A boolean indicating whether to use weighted causality.

The `print(pc)` function displays the results of the causality analysis, including the total, positive, negative, and dark causality percentages.
...
We hope this clearer and more intuitive explanation helps you better understand pattern causality!
